    ...
    return (
        <main className="games-hub">
                ...
                <div className="games-grid">
                    ...
                    {games.map((game, index) => (
                        ...
                        <button
                            ...
                            type="button"
                            className={
                                `game-card game-card--${game.accent} ${
                                    index === 0
                                        ? "game-card--featured"
                                        : ""
                                }`
            ...
            <section className="games-support">
                ...
                <div className="games-support__icon">
                    🔊
                </div>
